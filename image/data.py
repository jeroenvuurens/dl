...
def image_databunch(path, size, valid_perc=0.2, tfms=None, num_workers=2, batch_size=16):
    if tfms == None:
        tfms = get_transforms()
...
def text_image_databunch(path, size, valid_perc=0.2, num_workers=2, batch_size=64):
